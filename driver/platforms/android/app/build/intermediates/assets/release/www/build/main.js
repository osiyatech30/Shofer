...
var PickUpPage = (function () {
    function PickUpPage(nav, tripService, alertCtrl, dealService) {
        ...
        var getTrips = tripService.getTripStatus(this.trip.$key).subscribe(function (trip) {
    ...
    PickUpPage.prototype.showPayment = function () {
        ...
        this.alertCtrl.create({
            title: 'Trip Price - ' + this.trip.paymentMethod,
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\ionic_apps\shofer\driver\driver\src\app\app.html"*/'<ion-nav [root]="rootPage" #content></ion-nav>\n'/*ion-inline-end:"C:\ionic_apps\shofer\driver\driver\src\app\app.html"*/,
            queries: {
